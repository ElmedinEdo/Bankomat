...
public class Racun extends TransakcijaTest {
	...
	public Racun(int Id, double balans) {
		Racun.Id = Id;
		Racun.balans = balans;
	}
	...
	public void Isplati(double iznos) {
		if (balans < iznos || iznos < 00.0d) {
			System.out.println(
					" Nemate dovoljno sredstava na raèunu, ili je unešen negativan iznos, molimo pokušajte ponovo! ");
		} else {
			balans = balans - iznos;
		}
	}
